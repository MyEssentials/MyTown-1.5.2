...
public class MyTownNation {
                ...
                if (nation == null) // not in nation - new, accept, reject
                {
                    if (args.length == 1) {
                        ...
                        list.add(Term.TownCmdDeny.toString());
                            ...
                            && args[0].equalsIgnoreCase(Term.TownCmdNation
                                    .toString())) {
                        if (args.length == 2) {
                    ...
                    if (args.length > 1
                        ...
                        if (args.length == 2) {
                            ...
                            for (Town n : MyTownDatasource.instance.towns) {
                                ...
                                && (args[1]
                                        .equalsIgnoreCase(Term.TownCmdNationKick
                                                .toString()) || args[1]
                                        .equalsIgnoreCase(Term.TownCmdNationTransfer
                                                .toString()))) {
    ...
    public static boolean handleCommand(ICommandSender cs, String[] args)
        ...
        boolean nonresident = cs instanceof EntityPlayer
                && MyTownDatasource.instance.getOrMakeResident(
                        (EntityPlayer) cs).town() == null;
        ...
        if (nonresident
                ...
                && (args[0].equals("?")
                        || args[0]
                                .equalsIgnoreCase(Term.CommandHelp.toString()) || args[0]
            ...
            if (args.length < 3 && cs instanceof EntityPlayer) {
                ...
                if (res.town() == null || res.town().nation() == null) {
                    throw new CommandException(
                            Term.TownErrNationSelfNotPartOfNation);
                }
                ...
                if (n == null) {
                    throw new CommandException(Term.TownErrNationNotFound,
                            args[2]);
                }
            ...
            Collections.sort(sorted, new Comparator<Nation>() {
                ...
                public int compare(Nation arg0, Nation arg1) {
                    return Integer.compare(arg1.towns().size(), arg0.towns()
                            .size());
                }
            });
            ...
            for (Nation e : sorted) {
                String n = Term.TownCmdNationListEntry.toString(e.name(), e
                        .towns().size());
                if (i > 0) {
                    sb.append(", ");
                    /*
        ...
        if (nation == null) // not in nation - new, accept, reject
        {
            if (nonresident
                    ...
                    && args.length > 0
                    && (args[0].equals("?")
                            || args[0].equalsIgnoreCase(Term.CommandHelp
                                    .toString()) || args[0]
                            .equalsIgnoreCase(Term.TownCmdNation.toString())
                            && args.length < 2)) {
                if (args.length < 2
                ...
                if (town.pendingNationInvitation == null) {
                    throw new CommandException(
                            Term.TownErrNationYouDontHavePendingInvitations);
                }
                                                   ...
                                                   // delete, kick, transfer
        {
            if (args.length < 2
                ...
                if (args.length == 3) {
                    ...
                    if (t == town) {
                        throw new CommandException(
                                Term.TownErrNationInvitingSelf);
                    }
                ...
                if (args.length == 3) {
                    ...
                    if (t.nation() != nation) {
                        throw new CommandException(
                                Term.TownErrNationNotPartOfNation);
                    }

                    if (t == town) {
                        throw new CommandException(
                                Term.TownErrNationCannotKickSelf);
                    }
                ...
                if (args.length == 3) {
                    ...
                    if (t == town) {
                        throw new CommandException(
                                Term.TownErrNationCannotTransferSelf);
                    }
                ...
                if (args.length == 3 && args[2].equalsIgnoreCase("yes")) {
                    ...
                    String msg = Term.NationBroadcastDeleted.toString(nation
                            .name());
                    for (Object obj : MinecraftServer.getServer()
                            .getConfigurationManager().playerEntityList) {
                        ((EntityPlayer) obj).sendChatToPlayer(msg);
