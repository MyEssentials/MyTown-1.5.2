...
public class MyTownNation {
            ...
            if (res.town() != null && res.rank() == Rank.Mayor) {
                                                           ...
                                                           // kick, transfer
                {
                    if (args.length > 1 && args[0].equalsIgnoreCase(Term.TownCmdNation.toString())) {
                        ...
                        } else if (args.length == 3 && (args[1].equalsIgnoreCase(Term.TownCmdNationKick.toString()) || args[1].equalsIgnoreCase(Term.TownCmdNationTransfer.toString()))) {
    ...
    public static boolean handleCommand(ICommandSender cs, String[] args) throws CommandException, NoAccessException {
        ...
        {
            if (nonresident && args.length < 1 || !nonresident && args.length > 0 && (args[0].equals("?") || args[0].equalsIgnoreCase(Term.CommandHelp.toString()) || args[0].equalsIgnoreCase(Term.TownCmdNation.toString()) && args.length < 2)) {
                if (args.length < 2 && (args.length < 1 || !args[0].equalsIgnoreCase(Term.TownCmdNation.toString()))) {} else if (args[0].equalsIgnoreCase(Term.TownCmdNation.toString()) && args.length < 2 || args[1].equalsIgnoreCase(Term.CommandHelpNation.toString())) {
                    handled = true;
